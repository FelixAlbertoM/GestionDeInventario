        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "decimal(18,2)", maxLength: 300, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntradasDetalle", x => x.EntradaId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4.00m, "Cinta métrica 5 metros", 0, 7.00m },
                    { 2, 45.00m, "Taladro eléctrico 1/2 pulgada", 0, 70.00m },
                    { 3, 6.50m, "Martillo de acero 16 oz", 0, 10.00m }
                });
